...
public class Calculadora1 extends javax.swing.JFrame  {
    ...
    private void initComponents() {
        ...
        btn_error.setFocusPainted(false);
    ...
    private void btn_00ActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void btn_expActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void btn_dotActionPerformed(java.awt.event.ActionEvent evt) {
        addNumber(".");
    ...
    private void btn_oscuroActionPerformed(java.awt.event.ActionEvent evt) {
        if (!modoOscuro) {
    ...
    private void btn_errorActionPerformed(java.awt.event.ActionEvent evt) {
