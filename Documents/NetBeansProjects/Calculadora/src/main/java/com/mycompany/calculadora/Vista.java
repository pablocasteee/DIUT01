...
Boolean pulsado=false;
    ...
    public Vista() {
        ...
        this.jButton6.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("4"), "4");
        this.jButton6.getActionMap().put("4", new AbstractAction() {
        @Override 
        public void actionPerformed(ActionEvent ae) {
        
        }
        });
        this.jButton1.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("1"), "1");
        ...
        this.jButton2.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("2"), "2");
        ...
        this.jButton3.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("3"), "3");
        ...
        this.jButton13.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("0"), "0");
        this.jButton13.getActionMap().put("0", new AbstractAction() {
        @Override 
        public void actionPerformed(ActionEvent ae) {
        
        }
        });
        this.jButton7.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("5"), "5");
        this.jButton7.getActionMap().put("5", new AbstractAction() {
        @Override 
        public void actionPerformed(ActionEvent ae) {
        
        }
        });
        this.jButton8.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("6"), "6");
        this.jButton8.getActionMap().put("6", new AbstractAction() {
        @Override 
        public void actionPerformed(ActionEvent ae) {
       
        }
        });
        this.jButton9.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("7"), "7");
        this.jButton9.getActionMap().put("7", new AbstractAction() {
        @Override 
        public void actionPerformed(ActionEvent ae) {
        
        }
        });
        this.jButton10.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("8"), "8");
        ...
        this.jButton11.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("9"), "9");
    ...
    this.num1=Float.parseFloat(this.jTextField1.getText());
    this.operando="+";
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        ...
        this.num2=Float.parseFloat(this.jTextField1.getText());
        
        switch(operando){
           case "-": this.jTextField1.setText(Float.toString(this.num1-this.num2));break;
           case "+": this.jTextField1.setText(Float.toString(this.num1+this.num2));break;
           case "*": this.jTextField1.setText(Float.toString(this.num1*this.num2));break;
           case "/": this.jTextField1.setText(Float.toString(this.num1/this.num2));break;
   }  
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
         String texto = this.jTextField1.getText().substring(0, this.jTextField1.getText().length() - 1);
